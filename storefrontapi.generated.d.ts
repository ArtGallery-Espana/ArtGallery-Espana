...
export type HomepageProductFragment = Pick<
  ...
  | 'tags'
> & {
  anio?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
...
export type CatalogProductFragment = Pick<
  StorefrontAPI.Product,
  'id' | 'handle' | 'title' | 'productType' | 'createdAt' | 'tags'
> & {
  featuredImage?: StorefrontAPI.Maybe<
    Pick<StorefrontAPI.Image, 'id' | 'altText' | 'url' | 'width' | 'height'>
  >;
...
> & {
  ...
  anio?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  permite_ofertas?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
  options: Array<
...
export type ProductQuery = {
  product?: StorefrontAPI.Maybe<
    ...
    > & {
      ...
      profundidad?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      anio?: StorefrontAPI.Maybe<Pick<StorefrontAPI.Metafield, 'value'>>;
      permite_ofertas?: StorefrontAPI.Maybe<
