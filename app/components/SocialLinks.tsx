...
function SocialIcon({
  ...
  return (
    <a
      aria-label={label}
      className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-[rgba(35,35,39,.18)] text-[rgba(35,35,39,.62)] transition hover:border-[#C84D92] hover:text-[#C84D92]"
      href={href}
